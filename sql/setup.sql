...
INSERT INTO
    users (password_hash, secret_hash, email)
VALUES
(
        '$2b$10$cYidLM7q1F449Qm3a/a9a.XbqC.U24OQCcYkVyYZTwGkIhv8cFIk6',
        'shhdhshshsh',
        'barkbase@web.com'
    );
...
INSERT INTO
    pets (owner_id, name, birthday, image_url)
VALUES
(
        1,
        'Kharkiv',
...
INSERT INTO
    contacts (type, name, phone, email, address, owner_id, pet_id)
VALUES
(
        'vet',
        'bob',
...
INSERT INTO
    medical_info (vet_id, medicines, notes, next_appt, pet_id)
VALUES
(1, 'scotch', 'Take twice hourly', '2022-02-02', 1);